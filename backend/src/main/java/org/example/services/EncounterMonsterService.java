...
public class EncounterMonsterService {
     ...
     */
    public List<EncounterMonster> getMonsterList(int encounterId, String username, boolean isAdmin) {
    ...
    /**
     * Checks whether the user is allowed to view the encounter's monster list
     * @param encounterId the id of the encounter
     * @param username the username of the user
     * @param isAdmin whether the user is Admin
     */
